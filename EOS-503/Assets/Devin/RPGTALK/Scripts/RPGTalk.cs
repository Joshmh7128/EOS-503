...
public class RPGTalk : MonoBehaviour
{
    ...
    */
    ...
    private RpgtalkElement readSceneElement(string line)
    {
        ...
        //commenting this part out because non-npc variables will be handled below
        /*
        ...
        */
        ...
        else if (line.Contains("line19"))
        {
            line = line.Replace("line19", line19);
        }
        else if (line.Contains("line18"))
        {
            line = line.Replace("line18", line18);
        }
        else if(line.Contains("line17"))
        {
            line = line.Replace("line17", line17);
        }
        else if (line.Contains("line16"))
        {
            line = line.Replace("line16", line16);
        }
        else if (line.Contains("line15"))
        {
            line = line.Replace("line15", line15);
        }
        else if (line.Contains("line14"))
        {
            line = line.Replace("line14", line14);
        }
        else if (line.Contains("line13"))
        {
            line = line.Replace("line13", line13);
        }
        else if (line.Contains("line12"))
        {
            line = line.Replace("line12", line12);
        }
        else if (line.Contains("line11"))
        {
            line = line.Replace("line11", line11);
        }
        else if (line.Contains("line10"))
        {
            line = line.Replace("line10", line10);
        }
        else if (line.Contains("line09"))
        {
            line = line.Replace("line09", line09);
        }
        else if (line.Contains("line08"))
        {
            line = line.Replace("line08", line08);
        }
        else if (line.Contains("line07"))
        {
            line = line.Replace("line07", line07);
        }
        else if (line.Contains("line06"))
        {
            line = line.Replace("line06", line06);
        }
        else if (line.Contains("line05"))
        {
            line = line.Replace("line05", line05);
        }
        else if (line.Contains("line04"))
        {
            line = line.Replace("line04", line04);
        }
        else if (line.Contains("line03"))
        {
            line = line.Replace("line03", line03);
        }
        else if (line.Contains("line02"))
        {
            line = line.Replace("line02", line02);
        }
        else if (line.Contains("line01"))
        {
            line = line.Replace("line01", line01);
        }
        else if (line.Contains("line00"))
        {
    ...
    public bool LookForChoices(string line)
    {
        ...
        if (line.IndexOf("[choice=") != -1 && line.IndexOf("]", line.IndexOf("[choice=")) != -1)
        {
            ...
            else if (line.Contains("choice1"))
            {
                line = line.Replace("choice1", choice1);
            }
            else if (line.Contains("choice2"))
            {
    ...
    //for dynamically updating strings after a choice continues in the same .txt file
    //with current txt document structure, will not need this
    /*
    public void ReplaceVariable(int varNum, string newValue)
    {
        string myLine;
        string oldValue = variables[varNum].variableValue;
